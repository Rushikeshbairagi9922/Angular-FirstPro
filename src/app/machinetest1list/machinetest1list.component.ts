...
constructor(public rout: Router,public _httpdemo: HttpClientDemoService,  private networkcheck :NetworkcheckService ){
...
ngOnInit(): void {
  ...
  this._httpdemo.getMachinetest().subscribe((e:any)=>this.product=e.products);
